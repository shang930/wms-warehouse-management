  ...
  <div class="page-container">
    ...
    <div class="table-panel">
      ...
      <el-table v-loading="loading" :data="list" stripe border>
        ...
        <el-table-column label="操作" width="240"><template #default="{row}"><el-button link type="primary" size="small" @click="$router.push(`/cyclecount/detail/${row.id}`)">详情</el-button><el-button v-if="row.status===1" link type="success" size="small" @click="doStart(row)">开始</el-button><el-button v-if="row.status===3" link type="warning" size="small" @click="doAdjust(row)">调整</el-button></template></el-table-column>
      </el-table>
    </div>
